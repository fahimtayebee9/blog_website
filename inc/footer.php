    ...
    <script>
        ...
        <?php
            if(isset($_SESSION['toastr'])){
                if(isset($_SESSION['toastr_type']) && $_SESSION['toastr_type'] == "danger"){
                    ?>
                            toastr.danger("<?=$_SESSION['toastr'];?>")
                    <?php
                }
                else if(isset($_SESSION['toastr_type']) && $_SESSION['toastr_type'] == "error"){
                    ?>
                            toastr.error("<?=$_SESSION['toastr'];?>")
                    <?php
                }
                else if(isset($_SESSION['toastr_type']) && $_SESSION['toastr_type'] == "success"){
                    ?>
                            toastr.success("<?=$_SESSION['toastr'];?>" + "<?='<br>'.(time()-$time_fired)?>"+ "<?='<br>'.time()?>"+ "<?='<br>'.$time_fired?>")
                    <?php
                }
                else if(isset($_SESSION['toastr_type']) && $_SESSION['toastr_type'] == "warning"){
                    ?>
